...
対象に、2連単「1-2」に200円、「1-3」に100円（1レースあたり合計300円）を
賭け続けた場合について、対象データの最古日から5日ごとの期間に区切り、
期間ごとの対象レース数・的中回数・回収率を表にする。

period_breakdown_weighted.pyと同一内容で、BET_WEIGHTSのみ変更（1-4なし）。
"""
import sqlite3
...
print("買い目: 2連単 1-2(200円) + 1-3(100円) 、1レースあたり計300円")
